...
Considering equations of the form $ax^2+bx+c=0$. This is a quadratic equation; changing the values of $a$, $b$, and $c$, changes the shape of the quadratic. There are two solutions to a
quadratic equation:
...
fx <- a*x^2 + b*x + c
plot(x, fx, type = 'l', xlab = "x", ylab = "Quadratic function")
title(sub = "Figure 1: A quadratic function"
      )
# adding line for solution
abline(h = 0, lty = 2, col = "red")
```
